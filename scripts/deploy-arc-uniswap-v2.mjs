...
const tokens = {
  ...
  USDC: env.USDC_ADDRESS || env.NEXT_PUBLIC_USDC_ARC_ADDRESS || "0x3600000000000000000000000000000000000000",
  EURC: env.EURC_ADDRESS || env.NEXT_PUBLIC_EURC_ARC_ADDRESS || "0x89B50855Aa3bE2F677cD6303Cec089B5F319D72a",
  WETH: weth,
};
