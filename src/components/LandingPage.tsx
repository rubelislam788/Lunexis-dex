...
export default function LandingPage({ onNavigate }: LandingPageProps) {
  ...
  const liveStats = [
    ...
    { icon: "currency_exchange", color: "#3d6aff", label: "Rewards Claimed", value: formatRewardTotals(stats.rewardTokenTotals, stats.rewardsClaimed), tag: "LIVE_02" },
      ...
      <section className="arc-hero-section relative flex flex-col items-center justify-center px-6 sm:px-8 text-center">
        <div className="arc-hero-content relative z-10 max-w-5xl mx-auto arc-fade-up">
          ...
          <h1 className="arc-aurora-title" style={{ fontFamily: "'Space Grotesk'", fontSize: "clamp(36px,6vw,64px)", fontWeight: 900, lineHeight: 1.05, letterSpacing: 0, color: "#e9feff", marginBottom: 24 }}>
            <span className="arc-title-plain">Lunexis</span>{" "}
            <span className="arc-title-gradient">Operator Control.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: "military_tech",
                title: "Quest & Earn",
                desc: "Complete on-chain missions, earn USDC and EURC rewards, and climb the leaderboard.",
                color: "#8b5cf6",
