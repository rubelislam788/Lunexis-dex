...
const BASE_QUESTS: Quest[] = [
  ...
  { id: "q2", title: "Arc Liquidity Signal", description: "Hold Arc ecosystem assets and refresh your live wallet balances.", reward: "800 points + NFT", rewardAmt: 800, xp: 400, difficulty: "Medium", category: "Portfolio", progress: 0, totalSteps: 4, tags: ["Balance", "USDC"], featured: true, tasks: [
  ...
  { id: "q3", title: "Stablecoin Pair Operator", description: "Hold both USDC and EURC on Arc Testnet to prove you can operate the live swap route.", reward: "1,200 points", rewardAmt: 1200, xp: 600, difficulty: "Medium", category: "DeFi", progress: 0, totalSteps: 3, tags: ["USDC", "EURC"], tasks: [
  ...
  { id: "q4", title: "Route Pathfinder", description: "Complete a swap and keep gas available to prove operator capability.", reward: "2,500 points", rewardAmt: 2500, xp: 1000, difficulty: "Hard", category: "Advanced", progress: 0, totalSteps: 4, tags: ["Swap", "Gas"], tasks: [
