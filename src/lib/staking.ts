...
export const STAKING_MANAGER_ADDRESS = parseAddress(process.env.NEXT_PUBLIC_LUNEXIS_STAKING_MANAGER_ADDRESS);
...
export const DEFAULT_STAKING_TOKENS: StakingToken[] = [
  {
    address: (process.env.NEXT_PUBLIC_USDC_ARC_ADDRESS || "0x3600000000000000000000000000000000000000") as Address,
    name: "USD Coin",
    symbol: "USDC",
    decimals: 6,
  ...
  {
    address: (process.env.NEXT_PUBLIC_EURC_ARC_ADDRESS || "0x89B50855Aa3bE2F677cD6303Cec089B5F319D72a") as Address,
    name: "EURO",
    symbol: "EURC",
    decimals: 6,
