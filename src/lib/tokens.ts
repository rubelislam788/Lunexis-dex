...
export const TOKEN_CONTRACTS: Partial<Record<TokenSymbol, Partial<Record<number, Address>>>> = {
  USDC: {
    ...
    [ARC_TESTNET_CHAIN_ID]: (process.env.NEXT_PUBLIC_USDC_ARC_ADDRESS || "0xD8fBdB46F9230B952Ad820697ac940373208ea3e") as Address,
  },
  EURC: {
    [ARC_TESTNET_CHAIN_ID]: (process.env.NEXT_PUBLIC_EURC_ARC_ADDRESS || "0x588c08138f0d079E2B8457ea0Bf30861890875fb") as Address,
  },
};
